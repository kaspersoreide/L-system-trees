...
void main() {
    ...
    float w1 = 1.2 * tree[idx].width;
    float w0 = 1.2 * tree[tree[idx].parent].width; 
    ...
    //bottom corners
    vec3 c000 = p0 - w0 * v - w0 * w;
    vec3 c001 = p0 - w0 * v + w0 * w;
    vec3 c010 = p0 + w0 * v - w0 * w;
    vec3 c011 = p0 + w0 * v + w0 * w;
    //top corners
    vec3 c100 = p1 - w1 * v - w1 * w;
    vec3 c101 = p1 - w1 * v + w1 * w;
    vec3 c110 = p1 + w1 * v - w1 * w;
    vec3 c111 = p1 + w1 * v + w1 * w;
